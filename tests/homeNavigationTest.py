...
try:
    ...
    driver.close()
    print(f"[{filename}] - SUCCESS - This test script launches a Chrome web driver, navigates to a banking project login page, performs steps to log in as a customer, selects 'Harry Potter' from the dropdown menu, clicks the home button, and then closes the driver.")
except Exception:
